...
tabPanel( 
  ...
  fluidRow(
    ...
    column(4,selectInput("celltype", "Cell Type", choices = unique(deg$cell_type),
                         selected = unique(deg$cell_type)[1])),
...
tabPanel( 
  ...
  fluidRow(
    ...
    column(4,selectInput("celltype_markers", "Cell Type", choices = unique(markers$cluster),
                         selected = unique(markers$cluster)[1])),
